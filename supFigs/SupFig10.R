...
write.table(myDF, '/home/brasel/SingleCellProjects/MyProjects/67BrainsPaper/createSourceFiles_NatComm/SupFigs/SupFig10df.csv', sep = ', ', quote = F, row.names = T, col.names = T)
write.table(myStats, '/home/brasel/SingleCellProjects/MyProjects/67BrainsPaper/createSourceFiles_NatComm/SupFigs/SupFig10stats.csv', sep = ', ', quote = F, row.names = F, col.names = T)
