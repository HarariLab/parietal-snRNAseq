...
m = subset(m,subset=Status %in% c('NEURO_ADAD','NEURO_CO') )
m@meta.data$Status = factor(m@meta.data$Status, levels = c("NEURO_CO", "NEURO_ADAD"))
...
dir <- paste0('/home/bnovotny/single_nuclei/', celltype, '/nebula_de/DE_by_status/ADADvsCO/')
mainfilename <- paste('nebula_compareStatus', celltype, subclust, sep='_')
