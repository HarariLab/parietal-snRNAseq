...
m = readRDS('/home/brasel/SingleCellProjects/dataObjects/oligo.rds')
...
dir <- '/home/bnovotny/single_nuclei/oligodendrocyte/nebula_de/'
mainfilename <- paste('nebula_compareSubclusters_oligo', subclust1, subclust2,date, sep='_')
