...
m = readRDS('/home/brasel/SingleCellProjects/dataObjects/opc.rds')
...
m = subset(m,subset=Sample_ID %in% names(table(m@meta.data$Sample_ID)[table(m@meta.data$Sample_ID) > 66]))
...
dir <- '/home/bnovotny/single_nuclei/opc/nebula_de/'
mainfilename <- paste('nebula_compareSubclusters_opc', subclust1, subclust2,date, sep='_')
